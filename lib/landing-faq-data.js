/**
 * Preguntas frecuentes del landing Telvoice.cl (index.html / centro de ayuda).
 * Texto plano para el agente web; mantener alineado con la sección #faq del sitio.
 */
export const LANDING_FAQ = [
  {
    ...
    keys: ["que es una bolsa", "que es bolsa de sms", "bolsa de sms", "que es una bolsa de sms"],
  },
  {
    ...
    keys: [
      ...
      "como funciona sms masivos",
      "envio de sms masivos",
      "como enviar sms masivos",
    ],
  },
  {
    question: "¿Cómo compro una bolsa de SMS en Telvoice.cl?",
    answer:
      "En la calculadora del sitio eliges el volumen, revisas el precio con IVA y completas el pago con Mercado Pago. Recibes confirmación y acceso al portal para usar tus SMS.",
    keys: ["como compro", "como comprar bolsa", "como se compra"],
  },
  {
  ...
  },
  {
    ...
    keys: ["operadores moviles", "que operadores", "entel movistar claro wom"],
  },
  {
    ...
    keys: ["sms vencen", "vencen los sms", "vencimiento", "caducan", "expiran"],
  },
  {
    ...
    keys: ["soporte tecnico", "soporte en chile", "atencion chile"],
  },
  {
    ...
    keys: ["emiten factura", "factura electronica", "como se emite la factura"],
  },
  {
    ...
    keys: ["desde mi propio sistema", "mi sistema", "integrar mi sistema"],
  },
  {
    ...
    keys: ["campañas promocionales", "campanas promocionales", "marketing sms"],
  },
  {
    question: "¿Puedo cotizar grandes volúmenes?",
    answer:
      "Sí. Para volúmenes sobre 100.000 SMS mensuales puedes solicitar una cotización especial desde la sección Empresas o el formulario de contacto del sitio.",
    keys: ["grandes volumenes", "gran volumen", "100000", "100.000"],
  },
  {
    question: "¿Telvoice.cl es lo mismo que portal.telvoice.net?",
    answer:
      "Telvoice.cl está enfocado en el mercado chileno y en la compra de bolsas SMS. portal.telvoice.net es el portal cliente donde envías mensajes, revisas reportes y administras tu cuenta.",
    keys: ["portal telvoice", "telvoice cl es lo mismo", "diferencia portal"],
  },
];
