#!/usr/bin/env python3
"""Genera content/uso-responsable.html y uso-responsable/index.html."""

from pathlib import Path

from legal_common import render_content_fragment
from uso_responsable_sections import SECTIONS
...
<head>
  ...
  <meta name="description" content="Política de uso responsable de los servicios SMS de Telvoice.cl para campañas, API, OTP, notificaciones y comunicaciones empresariales." />
  <title>Uso Responsable | Telvoice.cl</title>
  <link rel="canonical" href="https://telvoice.cl/uso-responsable/" />
  <link rel="icon" href="../assets/telvoice-isotipo.png" type="image/png" sizes="any" />
  <meta name="theme-color" content="#0052cc" />
  <meta property="og:locale" content="es_CL" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="https://telvoice.cl/uso-responsable/" />
  <meta property="og:site_name" content="Telvoice" />
  <meta property="og:title" content="Uso Responsable | Telvoice.cl" />
  <meta property="og:description" content="Política de uso responsable de los servicios SMS de Telvoice.cl para campañas, API, OTP, notificaciones y comunicaciones empresariales." />
  ...
  <main class="legal-page">
    <article class="legal-doc mx-auto">
      <header class="legal-doc-header">
        ...
        <h1>Política de Uso Responsable</h1>
        <p class="legal-lead">Uso responsable de los servicios de mensajería SMS ofrecidos por Telvoice.cl.</p>
        ...
        <div class="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul class="mt-4 space-y-3">
              ...
              <li><a class="text-on-primary font-semibold" href="./" aria-current="page">Uso responsable</a></li>
            </ul>
          </div>
        </div>
      </div>
...
def main():
    (ROOT / "uso-responsable").mkdir(parents=True, exist_ok=True)
    fragment = render_content_fragment(SECTIONS, "uso_responsable_sections.py")
    page = render_page(fragment)
    page = page.replace("div", "div")

    (ROOT / "content" / "uso-responsable.html").write_text(fragment, encoding="utf-8")
    (ROOT / "uso-responsable" / "index.html").write_text(page, encoding="utf-8")
    print("Generated content/uso-responsable.html and uso-responsable/index.html")
