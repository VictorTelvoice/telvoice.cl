...
export function getAppPanelStyles(): string {
  return `
    ...
    .tv-dlr-report__filters-form { margin-bottom: 0.25rem; }
    .tv-dlr-report__filter-actions { margin-left: auto; }
    ...
    .tv-dlr-report__status-chip input { margin: 0; }
    ...
    .tv-dlr-report__columns {
      padding: 0.75rem 1rem 1rem;
      font-size: 0.82rem;
    }
    .tv-dlr-report__columns summary {
      cursor: pointer;
      font-weight: 600;
