...
export function getAppPanelStyles(): string {
  return `
    ...
    .tv-dash-action-btn:hover {
      transform: translateY(-1px);
      border-color: rgba(0, 82, 204, 0.22);
      box-shadow: 0 8px 20px rgba(0, 82, 204, 0.1);
      text-decoration: none;
    }
    .tv-dash-action-btn--primary {
      border-color: rgba(0, 82, 204, 0.18);
      background: linear-gradient(165deg, #eef4ff 0%, #f8fbff 55%, #ffffff 100%);
    }
    .tv-dash-action-btn__icon {
      width: 42px;
      height: 42px;
      border-radius: 10px;
      display: inline-flex;
    ...
    .tv-dash-action-btn--primary .tv-dash-action-btn__icon {
      background: linear-gradient(135deg, #0052cc, #0ea5e9);
      color: #fff;
      box-shadow: 0 4px 12px rgba(0, 82, 204, 0.25);
    }
    .tv-dash-action-btn__label {
      display: block;
      font-weight: 700;
      font-size: 0.9rem;
      line-height: 1.3;
