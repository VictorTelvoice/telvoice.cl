...
export const MAIN_NAV: NavItem[] = [
  ...
  { id: "agent-plans", href: "/admin/agent-plans", label: "Planes Agente", icon: "workspace_premium" },
  { id: "numeraciones", href: "/admin/numeraciones", label: "Numeraciones", icon: "sim_card" },
  { id: "sms-inbound", href: "/admin/sms-inbox", label: "SMS entrantes", icon: "sms" },
...
export const LEGACY_NAV: NavItem[] = [
  ...
  { id: "agent-sales", href: "/admin/agent-sales", label: "Ventas del Agente", icon: "storefront" },
