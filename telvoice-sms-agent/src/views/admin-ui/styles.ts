...
export function getAdminStyles(): string {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .tv-clients-status-cell { display: grid; gap: 0.55rem; min-width: 11rem; }
    .tv-clients-status-badges { display: flex; flex-wrap: wrap; gap: 0.25rem; }
    .tv-api-access-row { display: grid; gap: 0.3rem; }
    .tv-api-switch {
      display: inline-flex;
      align-items: center;
      gap: 0.45rem;
    ...
    .tv-api-switch__input:checked + .tv-api-switch__slider { background: #16a34a; }
    .tv-api-switch__input:checked + .tv-api-switch__slider::after { transform: translateX(16px); }
    .tv-api-switch__input:disabled + .tv-api-switch__slider { opacity: 0.55; }
    .tv-api-access-feedback { min-height: 1rem; margin: 0; font-size: 0.72rem; }
    ...
    a.tv-tab--link:hover { color: var(--tv-primary); }
    .tv-tab__count {
      margin-left: 0.35rem;
      background: var(--tv-bg);
    ...
    .tv-hero-phone--compact .tv-hero-phone__screen {
      padding-top: 2rem;
    }
    ...
    .tv-wholesale-scope .material-symbols-outlined {
      color: var(--tv-primary);
      font-size: 1.35rem;
      margin-top: 0.1rem;
    }
    ...
    .tv-wholesale-subnav__link:hover { color: var(--tv-primary); background: #fff; }
    .tv-wholesale-subnav__link--active {
      background: #fff;
      color: var(--tv-primary);
    ...
    .tv-wholesale-actions__group .tv-panel__title {
      font-size: 0.78rem;
      text-transform: uppercase;
      letter-spacing: 0.05em;
      color: var(--tv-muted);
    }
    .tv-wholesale-summary-grid {
      display: grid;
    ...
    @media (max-width: 960px) {
      .tv-wholesale-summary-grid { grid-template-columns: 1fr; }
    }
    .tv-wholesale-summary-panel .tv-panel__head {
      display: flex;
      align-items: flex-start;
      justify-content: space-between;
      gap: 0.75rem;
    ...
    .tv-wholesale-summary-panel .tv-panel__head h2 {
      margin: 0;
      font-size: 1rem;
      font-weight: 700;
    }
    .tv-wholesale-summary-panel .tv-panel__sub {
      margin: 0.2rem 0 0;
      font-size: 0.78rem;
      color: var(--tv-muted);
    }
    .tv-table--wholesale th {
      font-size: 0.68rem;
      white-space: nowrap;
    }
    .tv-table--wholesale .tv-wholesale-col-margin,
    .tv-table--wholesale th.tv-wholesale-col-margin {
      background: #f8fafc;
    }
    .tv-wholesale-rate-preview {
    ...
    .tv-wholesale-dlr--ok { color: var(--tv-ok); font-weight: 600; }
    .tv-wholesale-dlr--warn { color: var(--tv-warn); font-weight: 600; }
    .tv-wholesale-dlr--err { color: var(--tv-err); font-weight: 600; }
    .tv-wholesale-empty {
      padding: 0.75rem 0;
      font-size: 0.82rem;
      color: var(--tv-muted);
