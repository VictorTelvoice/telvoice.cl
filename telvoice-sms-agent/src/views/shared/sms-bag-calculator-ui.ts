...
import {
  ...
  SMS_BAG_CALC_PAGE_MAX_WIDTH_PX,
...
export function getSmsBagCalculatorStyles(): string {
  return `
    ...
    .tv-app-client .tv-buy-sms-page {
      ...
      width: min(100%, ${SMS_BAG_CALC_PAGE_MAX_WIDTH_PX}px) !important;
      max-width: ${SMS_BAG_CALC_PAGE_MAX_WIDTH_PX}px !important;
    ...
    .tv-buy-sms-calc .calc-panel {
      box-sizing: border-box;
      width: 100%;
      max-width: ${SMS_BAG_CALC_PANEL_MAX_WIDTH_PX}px;
      margin-left: auto;
      margin-right: auto;
      margin-top: 1.875rem;
      ...
      background: #ffffff;
      box-shadow: 0 12px 36px -15px rgba(0, 82, 204, 0.18);
    ...
    @media (min-width: 768px) {
      .tv-buy-sms-calc .calc-result-panel {
        padding: 1.125rem 1.3125rem 0.9375rem;
      }
    }
        ...
        <div class="pack-includes-block">
          ...
          <div class="pack-includes">
            <ul class="pack-includes-list">
              <li class="pack-includes-item"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span> Plataforma web</li>
              <li class="pack-includes-item"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span> Reportería</li>
              <li class="pack-includes-item"><span class="material-symbols-outlined" aria-hidden="true">check_circle</span> Acceso API</li>
            </ul>
          </div>
        </div>
  ...
  (function () {
    ...
    if (suggestionsEl) {
      tierSuggestions().forEach(function (item) {
        ...
        btn.setAttribute("aria-label", fmt(item.vol) + " SMS · $" + item.pxSMS + " + IVA por SMS");
        btn.appendChild(document.createTextNode(formatCalcChipVolume(item.vol) + " SMS"));
