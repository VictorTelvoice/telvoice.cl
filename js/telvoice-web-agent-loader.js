...
(function () {
  ...
  function injectBootStyles() {
    ...
    boot.textContent =
      ...
      "#telvoice-web-agent .tva-launcher-iso,#telvoice-web-agent .tva-launcher img{width:4.25rem;height:4.25rem;max-width:4.25rem;max-height:4.25rem}" +
